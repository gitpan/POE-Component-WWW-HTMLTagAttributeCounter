...
the C<event> argument to C<count()> method/event will recieve input
...
Unless an error occured the C<result> key will be present and its value will be a hashref
...
Unless an error occured the C<result_readable> will be present. The value will be the
...
Please report any bugs or feature requests to C<bug-poe-component-www-htmltagattributecounter at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-WWW-HTMLTagAttributeCounter>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-WWW-HTMLTagAttributeCounter>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-WWW-HTMLTagAttributeCounter>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-WWW-HTMLTagAttributeCounter>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-WWW-HTMLTagAttributeCounter>
